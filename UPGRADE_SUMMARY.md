...
- [x] Migrated 37 images to flat structure
...
3. ⚠️ **CRITICAL: Update Your GitHub Actions Workflows** ⚠️
...
5. Test your site build: bundle exec jekyll build
6. Test embed mode: Add ?embed=true to any story URL to see the embed mode UI with navigation banner
7. Explore new share/embed UI: Click the share button (icon with arrow) on stories or homepage to access share links and embed code
8. Optional: Install pillow-heif for HEIC/HEIF support (iPhone photos). Run: pip install pillow-heif. The framework gracefully degrades if not installed, converting HEIC to standard formats.
